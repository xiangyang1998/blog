...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="{{asset('Admin/images/icon/icon.png')}}">
    <link rel="shortcut icon" href="{{asset('Admin/images/icon/favicon.ico')}}">
    ...
    <script src="{{asset('Admin/js/selectivizr-min.js')}}" type="text/javascript"></script>
    <![endif]-->
    <!--[if lt IE 9]>
...
<section class="container-fluid">
    ...
    <div class="row">
        <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li class="active"><a href="/admin/ar">文章</a></li>
                ...
                <form action="" method="post" class="add-article-form">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <script id="article-content" name="Article" type="text/plain"></script>
                        </div>
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <ul class="category-list">
                                        ...
                                        <li>
                                            <label>
                                                <input name="category" type="radio" value="{{$a->id}}" checked>
                                                {{$a->column}} <em class="hidden-md">( 栏目ID: <span>{{$a->id}}</span> )</em></label>
                                        </li>
...
<script src="{{asset('Admin/css/bootstrap.min.css')}}"></script>
...
<script src="{{asset('Admin/lib/ueditor/lang/zh-cn/zh-cn.js')}}"></script>
